...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para la mejor amiga del fucking world:\n\nDesde el primer momento que te conoci por allá en el 2020 en Discord, no sabia la hermosa amistad que crearia contigo ningun dia , hora , segundo , minuto me arrepiento de haberte hablado ese día.\n\nGracias por acompañarme en cada paso, por entenderme incluso en silencio, y por hacerme saber que tengo a alguien que me apaña a pesar que estes triste brillas mas que cualquier piedra preciosa, vales oro jamas lo olvides.\n\nTe quiero mucho más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño, Javierilox";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2020-08-03T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-08-03T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos de amistad: <b>${days}</b> días<br>` +
      `Lo siento si no es la fecha es lo que me acuerdo xD <br>` +
      `Tiempo para ${eventDate.toLocaleDateString('es-ES', { month: 'long', day: 'numeric', year: 'numeric' })}: <b>${eventDays} días, ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
